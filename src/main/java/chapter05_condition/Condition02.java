...
public class Condition02 {
    public static void main(String[] args) {
        ...
        // int point = scanner.nextInt();로 작성하지 않고, 굳이 위에 선언하고, 밑에 대입하는 형태

        // 여기서부터 입력된 값이 어느 영역인지에 대한 조건문을 작성할 예정입니다.
        if (point > VIP) {
        ...
        /*
            ...
            다른 사람들과의 협업을 염두에 두고 사용되는 클래스 및 변수들을 초반부에 전부
            선언한 뒤 실제로 사용할 때 재대입을 하는 방식으로 작성하는 것이 가독성을 염두에 둔
            코드라고 할 수 있습니다.
         */
