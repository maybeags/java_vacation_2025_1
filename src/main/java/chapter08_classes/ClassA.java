...
/*
    1. 클래스란?
        ...
        예를 들어, "자동차"라는 클래스를 만든다면
        자동차의 속성(색상, 속도)과, 행동(가속, 정지)을 코드로 표현 가능.

    2. 객체(Object)란?
        클래스를 설계도로 봤을 때, 실제 사용할 수 있는 자동차(인스턴스)는 객체.
...
public class ClassA {
    ...
    // 메서드 정의 -> call1() 유형으로 작성
    void callName() {
        System.out.println(name + "을(를) 부릅니다.");
    }
}
/*
    ClassAMain.java를 생성하세요.
 */
